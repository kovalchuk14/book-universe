import{S as m,N as v,K as C,A as M,P as $,a as b,b as A,i as P}from"./assets/vendor-CvYJyY29.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))c(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&c(a)}).observe(document,{childList:!0,subtree:!0});function i(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(n){if(n.ep)return;n.ep=!0;const s=i(n);fetch(n.href,s)}})();const g="/book-universe/assets/women-one-BnSHht3A.jpg",f="/book-universe/assets/man-one-BGYlt4N7.jpg",h="/book-universe/assets/women-two-D6Gk07ZQ.jpg",N=[{text:"Great selection, fast delivery, and beautifully packaged books. My go-to store for weekend reads!",author:"Jane Doe",title:"Book Lover, Reader",alt:"User Avatar",avatar:g},{text:"Customer service was super helpful, and my order arrived earlier than expected. Highly recommend!",author:"John Smith",title:"Editor, BookMag",alt:"User Avatar",avatar:f},{text:"Love the curated picks and clear descriptions. Makes it easy to find my next favorite book. I like it!",author:"Emily Johnson",title:"Author, Novelist",alt:"User Avatar",avatar:h},{text:"Great selection, fast delivery, and beautifully packaged books. My go-to store for weekend reads!",author:"Jane Doe",title:"Book Lover, Reader",alt:"User Avatar",avatar:h},{text:"Customer service was super helpful, and my order arrived earlier than expected. Highly recommend!",author:"John Smith",title:"Editor, BookMag",alt:"User Avatar",avatar:f},{text:"Love the curated picks and clear descriptions. Makes it easy to find my next favorite book. I like it!",author:"Emily Johnson",title:"Author, Novelist",alt:"User Avatar",avatar:g}];function I(){const e=document.querySelector(".feedbackSwiper .swiper-wrapper");N.forEach(t=>{const i=document.createElement("li");i.classList.add("swiper-slide"),i.innerHTML=`
    ...
    `,e.appendChild(i)})}function T(){const e=document.querySelectorAll(".control-btn"),t=new m(".feedbackSwiper",{modules:[v,C,M],slidesPerView:1,spaceBetween:24,loop:!1,navigation:{nextEl:"#feedbackNext",prevEl:"#feedbackPrev"},keyboard:{enabled:!0,onlyInViewport:!0},a11y:{enabled:!0},breakpoints:{768:{slidesPerView:2},1440:{slidesPerView:3}},on:{slideChange(a){i(a),c(a)},afterInit(a){i(a),c(a)}}});function i(a){const l=document.getElementById("feedbackPrev"),_=document.getElementById("feedbackNext");l.disabled=a.isBeginning,_.disabled=a.isEnd}function c(a){e.forEach((l,_)=>{l.classList.toggle("active",_===a.realIndex)})}e.forEach(a=>{a.addEventListener("click",()=>{const l=parseInt(a.getAttribute("data-index"),10);t.slideTo(l)})});const n=document.getElementById("feedbackPrev"),s=document.getElementById("feedbackNext");return n.addEventListener("click",()=>{t.slidePrev(),n.blur()}),s.addEventListener("click",()=>{t.slideNext(),s.blur()}),t}I();T();m.use([v,$]);document.addEventListener("DOMContentLoaded",()=>{const e=new m(".swiper",{slidesPerView:1,spaceBetween:30,loop:!1,observer:!0,observeParents:!0,watchOverflow:!0,breakpoints:{768:{slidesPerView:2},1440:{slidesPerView:3}},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}});window.addEventListener("resize",()=>{e.update()})});const k=["https://books-backend.p.goit.global/books/category-list","https://books-backend.p.goit.global/books/top-books","https://books-backend.p.goit.global/books/category?category=","https://books-backend.p.goit.global/books/"];async function O(){return(await b.get(k[0])).data}async function U(){return(await b.get(k[1])).data}async function W(e){return(await b.get(k[2]+e)).data}async function H(e){return(await b.get(k[3]+e)).data}const r={book_category_list:document.querySelector(".book-categories-list"),book_category_list_wrap:document.querySelector(".book-categories-list-wrapper"),book_category_button:document.querySelector(".book-categories-list-container"),book_menu_text:document.querySelector(".book-select-menu"),books_list:document.querySelector(".book-list"),book_counter:document.querySelector(".book-counter"),book_show_more_button:document.querySelector(".book-button-show-more"),modal_book:document.querySelector(".modal-book"),modal_book_close_button:document.querySelector(".modal-book-close-button"),modal_book_info:document.querySelector(".modal-book-full-info"),modal_book_buy_button:document.querySelector(".modal-book-buy-button"),modal_book_add_card_button:document.querySelector(".modal-book-cart-button")},o={current_books_count:0,max_books_count:0,current_books_category_is_all:!0,book_list:[],book_list_with_category:[],books_per_page:4},d="/book-universe/assets/sprite-C3UW0zoa.svg";function j(e){const t=e.map(i=>`
        ...
        `}r.books_list.insertAdjacentHTML("beforeend",c)}function p(){r.book_counter.textContent=`Showing ${o.current_books_count} of ${o.max_books_count}`}function V(){r.books_list.innerHTML=""}function J(){r.modal_book.classList.add("modal--is-open")}function y(){r.modal_book.classList.remove("modal--is-open"),document.body.style.overflow=""}function D(e){r.modal_book_info.innerHTML=`
